...
import {
  ...
  PortalModule,
  TemplatePortal
} from "./chunk-XW4RGK3G.js";
import "./chunk-JGFHCJVV.js";
import "./chunk-FTZZESUS.js";
import {
  _StructuralStylesLoader
} from "./chunk-6NKTQYAE.js";
import {
  ENTER,
  FocusKeyManager,
  FocusMonitor,
...
import "./chunk-ACDGQDZP.js";
import {
  _CdkPrivateStyleLoader
} from "./chunk-HKBR2SOJ.js";
import "./chunk-U7TTOXMH.js";
import {
  DOCUMENT
...
var MatExpansionPanel = class _MatExpansionPanel extends CdkAccordionItem {
  ...
  _inputChanges = new import_rxjs4.Subject();
...
var MatExpansionPanelHeader = class _MatExpansionPanelHeader {
  ...
  _changeDetectorRef = inject(ChangeDetectorRef);
  _parentChangeSubscription = import_rxjs4.Subscription.EMPTY;
  constructor() {
    ...
    const accordionHideToggleChange = panel.accordion ? panel.accordion._stateChanges.pipe((0, import_operators.filter)((changes) => !!(changes["hideToggle"] || changes["togglePosition"]))) : import_rxjs4.EMPTY;
    this.tabIndex = parseInt(tabIndex || "") || 0;
    this._parentChangeSubscription = (0, import_rxjs4.merge)(panel.opened, panel.closed, accordionHideToggleChange, panel._inputChanges.pipe((0, import_operators.filter)((changes) => {
